      ...
      <tr id="asset-row-${id}" class="hover:bg-slate-900/5 transition">
        ...
        <td class="p-4 text-center">
          ...
          <div class="edit-ast-mode-${id} hidden flex justify-center gap-2">
            <button onclick="app.assets.saveAssetRow(${id})" class="text-emerald-600 hover:text-emerald-800 font-bold px-2 py-1 text-xs border border-emerald-200 rounded-md bg-emerald-50 cursor-pointer transition">Save</button>
